...
<!-- xml2tree-sonar.xsl -->
<!-- version 1.0 date: 26.02.2014 based on xml2tree-cgn-plain-bhl.xsl -->
<!-- version 1.1 date: 26.02.2014 print tokens in italics -->
<!-- version 1.2 date: 28.02.2014 print root/pos if no lemma/pt -->
...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template name="layout2svg">
        ...
        <!-- Create SVG wrapper -->
        <svg:svg
                viewBox="{-1 * $xunit} {-1 * $yunit} {sum($layout/node/@width) * 2 * $xunit + $xunit} {$maxDepth * 2 * $yunit + 4 * $yunit}"
